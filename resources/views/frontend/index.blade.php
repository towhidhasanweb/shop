                                ...
                                <div class="product-area clearfix">
                                    ...
                                    <div class="grid">
                                        <div class="product-pic">
                                            <img src="{{asset('upload/product/thumbnails')}}/{{$products->thumbnails}}" alt>
                                            @if($products->discount)
                                            <span class="theme-badge-2">{{$products->discount}}% off</span>
                                            @endif
                                        </div>
                                        <div class="details">
                                            ...
                                            <span class="price">
                                                 ...
                                                 <ins>
                                                        <span class="woocommerce-Price-amount amount">
                                                            <bdi>
                                                                <span class="woocommerce-Price-currencySymbol">TK</span>{{$products->after_discount}}
                                                            </bdi>
                                                        </span>
                                                    </ins>
                                                @if($products->discount)
                                                <del aria-hidden="true">
                                                    <span class="woocommerce-Price-amount amount">
                                                        <bdi>
                                                            <span class="woocommerce-Price-currencySymbol">$</span>{{$products->product_price}}
                                                        </bdi>
                                                    </span>
                                                </del>
                                                @endif
